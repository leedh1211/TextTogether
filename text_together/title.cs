...
public class title
{
    public static String titleAsciiArt =
        "\n           _______  _______  __   __  _______  _______  _______  _______  _______  _______  __   __  _______ \n          |       ||       ||  |_|  ||       ||       ||       ||       ||       ||       ||  | |  ||       |\n          |_     _||    ___||       ||_     _||_     _||   _   ||    ___||    ___||_     _||  |_|  ||    ___|\n            |   |  |   |___ |       |  |   |    |   |  |  | |  ||   | __ |   |___   |   |  |       ||   |___ \n            |   |  |    ___| |     |   |   |    |   |  |  |_|  ||   ||  ||    ___|  |   |  |       ||    ___|\n            |   |  |   |___ |   _   |  |   |    |   |  |       ||   |_| ||   |___   |   |  |   _   ||   |___ \n            |___|  |_______||__| |__|  |___|    |___|  |_______||_______||_______|  |___|  |__| |__||_______|\n";
